...
The Maya civilization, which flourished in Mesoamerica from roughly 2000 BC to 1500 AD, 
left behind a rich and sophisticated system of writing known as hieroglyphs. 
These intricate symbols were inscribed on everything from ceramics and sculptures to buildings 
and books, and they recorded everything from everyday life to religious beliefs and 
historical events.
...
folded to books (see~\ref{label_introduction_example_dresden_codex}).
\begin{figure}
    \centering
    \includegraphics[height=8cm,keepaspectratio]{img/example-dresden-codex}
    \label{label_introduction_example_dresden_codex}
    \caption{Sample pages of the \emph{Dresden Codex} unfolded}
\end{figure}
...
namely the \emph{Dresden Codex}, the \emph{Madrid Codex} (also called \emph{Troano Codex}),
...
in deciphering the full range of Maya hieroglyphs and understanding the grammar and syntax of 
the Maya language. 
...
not every sign is fully understood.
However, what it is fascinating after all, is the fact, that it was possible to decipher most parts
...
finalized document.
It will evolve through time and each release will make the history more and more complete.
...
in the 16th century.
This work will then focus on the discoveries made in the 19th and 20th century up until today.
