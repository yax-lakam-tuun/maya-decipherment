...
\begin{figure}
    ...
    \subfloat[][]{
        \centering
        \includegraphics[width=0.49\textwidth]{img/panel-with-royal-woman}
        \label{fig:introduction-panel-with-royal-woman}
    }
    \subfloat[][]{
        \centering
        \includegraphics[width=0.49\textwidth]{img/vessel-with-battle-scene}
...
\begin{figure}[ht]
    ...
    \subfloat[][]{
        \centering
        \includegraphics[width=0.49\textwidth]{img/chilam-balam-of-tizimin-cover-page}
        \label{fig:introduction-chilam-balam-of-tizimin-cover-page}
    }
    \subfloat[][]{
        \centering
        \includegraphics[width=0.49\textwidth]{img/chilam-balam-of-ixil-page-20r}
