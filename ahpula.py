...
class HaabDate:
    ...
    def standard_notation(self):
        month = self.month()
        month_name = month.standard()
        last_day = HaabDate.WAYEB_DAYS if month.ordinal() == 19 else HaabDate.WINAL_DAYS
        return f"End of {month_name}" if self.day() == last_day else f"{self.day()} {month_name}"
