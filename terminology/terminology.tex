...
\section{Transliteration of Maya signs}
...
\begin{itemize}
    ...
    \item Signs with infixed graphemes are written in their-order of reading and the infix is placed
          in square brackets 
          % LTeX: enabled=false
          (e.g. \syllabogram{ch\glottalstop{}o}\syllabogram{[ko]}).
          % LTeX: enabled=true
...
\section{Transcribing of Maya texts}
For transcribing Maya texts, the following conventions are used:
\begin{itemize}
