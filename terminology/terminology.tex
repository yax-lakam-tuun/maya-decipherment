...
\begin{table}[!ht]
    ...
    \caption{Writing systems, their types and their number of distinct signs 
             (after~\cite[43]{coe1992};~\cite[730]{daniels1990};~\cite[88]{coulmas1991};~\cite{ritner1996})}
...
(\cite[2]{zender2017};~\cite[44]{coe1992}).

\subsection{Language}
\textcquote[44]{coe1992}{The language must be known, or at least a reconstructed,
ancestral version, in vocabulary, grammar, and syntax; at the very minimum, 
the linguistic family to which the language of the script belongs should be known.}
\textcquote[3]{zender2017}{Absent some external evidence of the language, decipherment is 
impossible}.
