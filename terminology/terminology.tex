...
script, was the breakthrough Jean-Fran\c{c}ois Champollion had when analyzing the so-called 
Rosetta Stone which had a text written in three different writing systems, 
namely Greek, Demotic and Egyptian hieroglyphs.
Jean-Fran\c{c}ois Champollion first focused on names of rulers which have been written both in 
Greek and in hieroglyphs on the so-called Rosetta Stone. 
Since Greek was well understood, the bilingual script helped him to compare the Greek writing and 
...
This insight opened the possibility to assign phonemes to hieroglyphic signs and played a major
role to decipher Egyptian hieroglyphs. 
\begin{center}
    \includegraphics[width=.7\textwidth,keepaspectratio]{img/ptolemy-cartouche}
    \captionof{figure}{Ptolemy written in Egyptian hieroglyphs with the phonetic decipherment 
                       (\authordrawings)}
