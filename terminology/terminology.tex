...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.63\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/chilam-balam-kakupakal}
        \caption{Except for the Book of Chilam Balam of Chumayel}
        \label{fig:tterminology-chilam-balam-kakupakal}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/chichen-itza-monjas-lintel-2-kakupakal}
        \caption{Chich\'{e}n Itz\'{a} Monjas Lintel 2 (B1)}
        \label{fig:terminology-chichen-itza-monjas-lintel-2-kakupakal}
    \end{subfigure}
    \caption{The name \mayan{K'ak'upakal} in the colonial sources and in the 
             inscriptions of Chich\'{e}n Itz\'{a}.}
\end{figure}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Questionable T-number assignment in Thompson's catalog (after Kelley)}
\end{figure}
% LTeX: enabled=true
